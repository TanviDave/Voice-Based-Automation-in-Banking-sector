...
<form:form method="get" modelAttribute="areaVo" action="saveArea.htm">
...
<form:option value="${i.stateId}">${i.stateName}</form:option>
              ...
              <div class="input-group">
                ...
                <form:select class="form-control" name="cityId" id="cityId"  path="cityId.cityId"></form:select>
              ...
              <div class="input-group">
                ...
                <form:input type="text" class="form-control" placeholder="Enter Area" path="areaName"/>
              </div>
