...
<form:form method="get" modelAttribute="lvo" action="saveLoan.htm">
          ...
          <div class="boxed animated flipInY">
            <div class="inner">
              ...
              <div class="input-group">
                ...
                <form:input type="text" class="form-control" placeholder="Loan Type" path="lType" />
              </div>

              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                <form:input type="text" class="form-control" placeholder="Loan Description" path="lDesc"/>
              </div>
