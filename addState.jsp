...
<form:form method="get" modelAttribute="svo" action="saveState.htm">
          ...
          <div class="boxed animated flipInY">
            <div class="inner">
              ...
              <div class="input-group">
                ...
                <form:input type="text" class="form-control" placeholder="State" path="stateName"/>
              </div>
