...
<form:form method="post" modelAttribute="cvo" action="saveCity.htm">
          ...
          <div class="boxed animated flipInY">
            <div class="inner">
              ...
              <div class="input-group">
                ...
                <form:select path="stateId.stateId"  id="stateId" class="form-control" placeholder="select state">
...
<form:option value="${i.stateId}">${i.stateName}</form:option>
              ...
              <div class="input-group">
                ...
                <form:input type="text" class="form-control" placeholder="Enter City" path="cityName"/>
              </div>
